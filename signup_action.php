...
$query="insert into login(username,password,user_type,user_status) values('$username','$password','user','approved')";
mysqli_query($con,$query);
$log=mysqli_insert_id($con);
$sql="insert into signup(name,email,phone,address,login_id) values('$name','$email','$phone','$address','$log')";
