...
<body>
    <div class="payment-container">
        ...
        <form action="pay_product_action.php?id=<?php echo $id; ?>" method="POST">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="cvv" name="cvv" placeholder="123" maxlength="4" pattern="[0-9]{3,4}" required>
                </div>
            </div>
