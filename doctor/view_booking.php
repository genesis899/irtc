...
<div class="container py-5">
  ...
  <?php
    ...
    $str = "SELECT a.*, u.name AS user_name, u.phone 
        FROM appointment a
          ...
          <?php while ($data = mysqli_fetch_array($result)) { ?>
            <tr>
              ...
              <?php } elseif ($data['status'] == 'pending') { ?>
                <td>
                  <a href="approve.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-success">Approve</a>
                  <a href="reject.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-danger">Reject</a>
                </td>
